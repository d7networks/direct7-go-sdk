...
func (v *Viber) SendViberMessage(recipients []string, content, label, originator, callBackURL string) ([]byte, error) {
...
func (v *Viber) GetStatus(requestID string) ([]byte, error) {
